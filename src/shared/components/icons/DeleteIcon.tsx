  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 18 18" fill="none">
      ...
      <Path
        ...
        strokeLinecap="round"
      />
      <Path d="M7.125 12.375V7.875" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <Path d="M10.875 12.375V7.875" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    </Svg>
  );
}
